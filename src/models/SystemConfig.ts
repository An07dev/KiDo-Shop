...
import { masterDbConnection } from '@/lib/mongodb';
...
export const SystemConfig: Model<ISystemConfig> =
  masterDbConnection.models.SystemConfig || masterDbConnection.model<ISystemConfig>('SystemConfig', SystemConfigSchema);
